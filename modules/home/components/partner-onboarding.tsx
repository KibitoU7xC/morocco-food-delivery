...
export default function PartnerOnboarding() {
  return (
    <section className="relative w-full py-16 bg-[#FAF8FC] border-t border-[#e4e1ea]/60 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-xl mx-auto mb-12">
          ...
          <p className="text-sm text-[#54525d] mt-2 font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1: Rider */}
          <div className="bg-white rounded-3xl p-6 border border-[#e4e1ea]/80 shadow-xs hover:shadow-md transition-all flex flex-col items-center text-center justify-between">
            <div className="flex flex-col items-center">
              <div className="w-28 h-28 rounded-full overflow-hidden mb-4 border-2 border-emerald-100 p-1">
                <img
              ...
              <h3 className="text-lg font-bold text-[#19181f] mb-2">Become a Rider</h3>
              <p className="text-xs sm:text-sm text-[#54525d] leading-relaxed mb-6">
                Complete schedule freedom, weekly direct deposits, and accident insurance on every single trip.
              </p>
            </div>
            <a
              href="/register"
              className="w-full py-2.5 rounded-full bg-[#006d43] hover:bg-emerald-800 text-white text-xs font-bold transition-colors text-center shadow-xs cursor-pointer"
            >
              Register as Rider
            </a>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6 border border-[#e4e1ea]/80 shadow-xs hover:shadow-md transition-all flex flex-col items-center text-center justify-between">
            <div className="flex flex-col items-center">
              <div className="w-28 h-28 rounded-full overflow-hidden mb-4 border-2 border-amber-100 p-1">
                <img
              ...
              <h3 className="text-lg font-bold text-[#19181f] mb-2">Partner your Business</h3>
              <p className="text-xs sm:text-sm text-[#54525d] leading-relaxed mb-6">
            ...
            <a
              href="/register"
              className="w-full py-2.5 rounded-full bg-[#5906e7] hover:bg-[#4502b8] text-white text-xs font-bold transition-colors text-center shadow-xs cursor-pointer"
            >
              Register Store
            </a>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6 border border-[#e4e1ea]/80 shadow-xs hover:shadow-md transition-all flex flex-col items-center text-center justify-between">
            <div className="flex flex-col items-center">
              <div className="w-28 h-28 rounded-full overflow-hidden mb-4 border-2 border-purple-100 p-1">
                <img
              ...
              <h3 className="text-lg font-bold text-[#19181f] mb-2">Careers at Orders.ma</h3>
              <p className="text-xs sm:text-sm text-[#54525d] leading-relaxed mb-6">
            ...
            <a
              href="#"
              className="w-full py-2.5 rounded-full bg-[#19181f] hover:bg-black text-white text-xs font-bold transition-colors text-center shadow-xs cursor-pointer"
            >
              View Open Roles
            </a>
          </div>
