...
export default function AppPromo() {
  return (
    <section className="w-full py-12 sm:py-16 lg:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden" id="download-app">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-6 space-y-4 sm:space-y-6">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#19181f] tracking-tight">
            Track your rider live, straight to your hands
          </h2>

          <p className="text-sm sm:text-base text-[#54525d] leading-relaxed">
          ...
          <ul className="space-y-2.5 sm:space-y-3 pt-2">
            <li className="flex items-center gap-3 text-xs sm:text-sm text-[#19181f] font-medium">
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 pt-2 sm:pt-4">
            <a
              href="#"
              className="flex items-center gap-2 px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-black text-white hover:bg-neutral-800 transition-all shadow-sm active:scale-95"
            >
              ...
              <div className="flex flex-col text-left">
                <span className="text-[9px] sm:text-[10px] leading-none opacity-80">Download on the</span>
                <span className="text-[11px] sm:text-xs font-bold leading-tight">App Store</span>
              </div>
            </a>
            ...
            >
              ...
              <div className="flex flex-col text-left">
                <span className="text-[9px] sm:text-[10px] leading-none opacity-80">Get it on</span>
                <span className="text-[11px] sm:text-xs font-bold leading-tight">Google Play</span>
              </div>
            </a>

            {/* QR Scan Pill */}
            <div className="hidden sm:flex items-center gap-2 px-3 py-2 rounded-xl bg-[#f7f5fa] border border-[#e4e1ea]">
              <svg className="w-7 h-7 text-[#19181f]" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="lg:col-span-6 relative flex items-center justify-center pt-4 lg:pt-0">
          <div className="relative w-full max-w-md h-[340px] xs:h-[380px] sm:h-[400px] bg-gradient-to-tr from-amber-50 via-purple-50 to-emerald-50 rounded-2xl sm:rounded-3xl p-4 sm:p-6 flex items-center justify-center border border-[#e4e1ea]/60">
            {/* Mock Phone 1 (Back) */}
            <div className="absolute right-0 xs:-right-2 top-6 sm:top-8 w-44 xs:w-52 sm:w-60 bg-white rounded-2xl sm:rounded-3xl p-2.5 sm:p-3 shadow-xl border border-[#e4e1ea] transform rotate-6 opacity-90">
              <div className="h-2 sm:h-2.5 w-10 sm:w-12 bg-gray-200 rounded-full mx-auto mb-2" />
              <div className="w-full h-24 xs:h-28 sm:h-32 rounded-xl overflow-hidden mb-2">
                <img
              ...
              <div className="p-1.5 sm:p-2 bg-gray-50 rounded-lg">
                <span className="text-[10px] sm:text-[11px] font-bold text-[#19181f] block">Rider Yassine is nearby!</span>
                <span className="text-[9px] sm:text-[10px] text-[#006d43] font-semibold">4 mins away</span>
              </div>
            </div>

            {/* Mock Phone 2 (Front) */}
            <div className="relative z-10 w-48 xs:w-56 sm:w-64 bg-white rounded-2xl sm:rounded-3xl p-2.5 sm:p-3 shadow-2xl border border-[#e4e1ea] transform -rotate-3 hover:rotate-0 transition-transform duration-300">
              <div className="h-2 sm:h-2.5 w-10 sm:w-12 bg-gray-200 rounded-full mx-auto mb-2" />
              <div className="w-full h-28 xs:h-32 sm:h-36 rounded-xl overflow-hidden relative mb-2">
                <img
              ...
              <div className="p-2 sm:p-2.5 bg-amber-50 rounded-xl flex items-center justify-between border border-amber-200">
                <div className="flex items-center gap-1.5">
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#d99700]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                  </svg>
                  <span className="text-[11px] sm:text-xs font-bold text-[#19181f]">2 items</span>
                </div>
